...
until curl \
    ...
    --url https://jaydenstaticwebsite.s3.ap-southeast-1.amazonaws.com/img/edinburgh1.jpg ; do
    sleep 1
done
sudo chmod a+w /var/www/html/index.html
echo "<html><head></head><body><center><H1>" > /var/www/html/index.html
echo $HOSTNAME >> /var/www/html/index.html
echo "<BR><BR>Edge VPC - Welcome to Edinburgh by Jayden <BR><BR>The New Town is only the Beginning!<BR><BR>" >> /var/www/html/index.html
